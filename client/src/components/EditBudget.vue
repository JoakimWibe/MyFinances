...
const { budget, editBudget, fetchBudgetById } = transactionsStore;
...
const handleSubmit = async () => {
    ...
    try {
        await editBudget(id, editedBudget)
...
<template>
    <div>
        <form @submit.prevent="handleSubmit" :disabled="loadingStates.editingBudget">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Budget</h2>
            ...
            <div class="space-y-4">
                ...
                <button
                    ...
                    type="submit"
                    :disabled="loadingStates.editingBudget"
                >
                <i v-if="loadingStates.editingBudget" class="pi pi-spin pi-spinner"></i>
                <span>{{ loadingStates.editingBudget ? 'Editing Budget...' : 'Edit Budget' }}</span>
                </button>
            </div>
        </form>
    </div>
